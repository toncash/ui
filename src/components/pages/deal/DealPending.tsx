...
import {dealsService, ordersUserService, usersService} from "../../../config/service-config"
  ...
  return (
      <section className={classes.orderPage}>
        ...
        <div className={classes.orderItem}>
          ...
          {!isDealOwner?<Link className={classes.chatLink} to={`https://t.me/${client.username}`}>See Chat
          </Link>:''}
        </div>
        ...
        {!isDealOwner ?
            ...
            <div className={classes.buttonContainer}>
              ...
              <button className={classes.buttonValueCame} onClick={async ()=>{
                dealContract.sendComplete()
              }}>Complete a deal</button>

             : <button className={classes.buttonValueCame} onClick={()=>dealsService.cancelDeal(deal.id as string)}>Deploy the contract</button>
              } </div>
